...
epochs = 15
hidden_size = 128
# input_size is 784 since we flatten out each image before sending it inside the neural network. (28 x 28 = 784)
input_size = 784
output_size = 10
lr_rate = 0.01
...
# Step 4. Create Model
model = torch.nn.Sequential(nn.Linear(input_size, hidden_size),
                      nn.ReLU(),
